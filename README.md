...
This is a C compiler targeting the cpu I designed in [Digital](https://github.com/hneemann/Digital). At some point I'll make a repository with the cpu schematics. This repository also has an emulator for the cpu written in Rust.
